document.addEventListener("DOMContentLoaded", async () => {
  try {
    ...
    if (carouselInner) {
      carouselInner.innerHTML = categories
        .map(
          (category, index) => `
          ...
          .map((product) => {
            ...
            return `
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="rounded position-relative fruite-item" data-product-id="${
                              product.name
                            }">
              ...
              product.name
                                    ...
                                    <div class="position-absolute top-0 end-0 p-2">
                                        <i class="fa fa-heart heart-icon ${
                                          isProductInWishlist ? "filled" : ""
                                        }" style="font-size: 18px; cursor: pointer;" onclick="handleHeartClick(event,'${
              product._id
            }')"></i>
                                    </div>  
                                </div>
                                ...
                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                    ...
                                    <div class="d-flex justify-content-center flex-lg-wrap">
                                        ...
                                        <a href="#" class="btn border border-secondary rounded-pill px-3 text-primary add-to-cart-btn" data-product-id="${
                                          product._id
                                        }">
